  ...
  return (
    <div className="min-h-screen bg-bg-base flex items-center justify-center p-8">
      <div className="max-w-md text-center">
        ...
        <h1 className="text-2xl font-bold text-text-primary mb-3">Google Workspace</h1>
        ...
        <p className="text-text-muted text-sm mb-8">
          In the meantime, you can use <strong className="text-text-primary">Microsoft 365</strong> for email, files, and calendar.
        </p>
        <Link href="/integrations" className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-black rounded-lg text-sm font-semibold hover:bg-gray-100 transition">
