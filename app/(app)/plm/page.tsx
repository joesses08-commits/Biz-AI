                    ...
                    {collections.map((c: any) => {
                      ...
                      return (
                        <button key={c.id}
                          ...
                          className={`text-[10px] px-3 py-1.5 rounded-lg border transition font-medium ${allSelected ? "border-2 border-amber-500 bg-amber-500/10 text-gray-900 font-bold" : "border-bg-border text-text-secondary"}`}>
                              ...
                              <div className="flex flex-wrap gap-1.5">
                                {factories.map((f: any) => (
                                  <button key={f.id} onClick={() => setBulkSampleSelections(prev => ({
                                    ...
                                    className={`text-xs px-2.5 py-1 rounded-lg border transition ${selectedFactories.includes(f.id) ? "border-2 border-amber-500 bg-amber-500/10 text-gray-900 font-bold" : "border-bg-border text-text-muted hover:text-text-secondary"}`}>
                                    {f.name}
                                  </button>
                                ))}
                              </div>
