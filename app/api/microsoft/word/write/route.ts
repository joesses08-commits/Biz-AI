...
export async function POST(req: NextRequest) {
  try {
    ...
    // CREATE new Word file in OneDrive root
    if (action === "create") {
      // Create empty docx via upload
      const res = await fetch(`https://graph.microsoft.com/v1.0/me/drive/root:/${fileName || "Jimmy AI Document"}.docx:/content`, {
        method: "PUT",
        headers: {
